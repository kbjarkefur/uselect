...
import delimited C:\Users\Kristoffer\Documents\GitHub\uselectdata\data\intermediatedata\uscencusbureau\cleancsv\geocode.csv, delimiter(comma) varnames(1) case(preserve) rowrange(6) clear 

label var sumlvl 		"Summary Level. 10 is nation, 40 is state, 50 is nations"
